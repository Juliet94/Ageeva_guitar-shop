...
import guitar from '../../assets/images/guitar-header.png';
  ...
  return (
    <header>
      <div className={styles.wrapper}>
        <div className={styles.inner_wrapper}>
          <NavLink
            ...
            to={AppRoute.CATALOG}
            activeClassName={styles.logo_link_active}
            isActive={(match, {pathname}) => !match ? false : pathname === AppRoute.CATALOG}
          >
          ...
          <div className={styles.icon_wrapper}>
            <ul className={styles.list_icons}>
              <li className={styles.icon_item}>
                <Link to={AppRoute.LOCATION}>
                  <span className="visually-hidden"> Местоположение </span>
                  <svg className={styles.icon_image_location} width="14" height="17" viewBox="0 0 14 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12.875 7.35227C12.875 11.8068 6.875 15.625 6.875 15.625C6.875 15.625 0.875 11.8068 0.875 7.35227C0.875 5.83331 1.50714 4.37655 2.63236 3.30248C3.75758 2.22841 5.2837 1.625 6.875 1.625C8.4663 1.625 9.99242 2.22841 11.1176 3.30248C12.2429 4.37655 12.875 5.83331 12.875 7.35227Z" stroke="black" />
                    <path d="M6.875 9.26154C7.97957 9.26154 8.875 8.40681 8.875 7.35245C8.875 6.29809 7.97957 5.44336 6.875 5.44336C5.77043 5.44336 4.875 6.29809 4.875 7.35245C4.875 8.40681 5.77043 9.26154 6.875 9.26154Z" stroke="black"/>
                  </svg>
                </Link>
              </li>
              <li className={styles.icon_item}>
      ...
      <div className={styles.guitar_wrapper}>
        <img className={styles.img_guitar} src={guitar} alt="Электрогитара"/>
      </div>
    </header>
  );
}
